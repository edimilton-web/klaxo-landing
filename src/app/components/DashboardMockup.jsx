...
const subs = [
  {
    initial: "S", color: "#FF6B6B", name: "Slack Pro", cat: "Communication",
    users: ["AR", "ML", "JP"], extra: 12, date: "Jun 1", dateWarn: false,
    amount: "€89.90", status: "duplicate", owner: "AR", ownerColor: "#6366F1",
  },
  {
    initial: "N", color: "#7B8CDE", name: "Notion", cat: "Productivity",
    users: ["AR", "SL"], extra: 3, date: "Jun 5", dateWarn: false,
    amount: "€48.00", status: "unused", owner: "SL", ownerColor: "#EC4899",
  },
  {
    initial: "V", color: "#5B7EFF", name: "Vercel Pro", cat: "Dev Tools",
    users: ["AR", "ML"], extra: 0, date: "Jun 3", dateWarn: true,
    amount: "€20.00", status: "active", owner: "ML", ownerColor: "#10B981",
  },
  {
    initial: "G", color: "#61AFEF", name: "GitHub Teams", cat: "Dev Tools",
    users: ["AR", "JP", "SL"], extra: 2, date: "Jun 10", dateWarn: false,
    amount: "€32.00", status: "active", owner: "AR", ownerColor: "#6366F1",
  },
  {
    initial: "F", color: "#A78BFA", name: "Figma", cat: "Design",
    users: ["SL", "JP"], extra: 0, date: "Jun 15", dateWarn: false,
    amount: "€36.00", status: "unused", owner: "SL", ownerColor: "#EC4899",
  },
  {
    initial: "L", color: "#10B981", name: "Linear", cat: "Dev Tools",
    users: ["AR", "ML", "JP"], extra: 0, date: "Jun 20", dateWarn: false,
    amount: "€26.00", status: "trial", owner: "ML", ownerColor: "#10B981",
  },
];

const userColors = {
  AR: "#6366F1", ML: "#10B981", JP: "#F59E0B", SL: "#EC4899",
};

const StatusBadge = ({ status }) => {
  const map = {
    active:    { label: "Active",    bg: "rgba(16,185,129,.15)",  color: "#34D399" },
    duplicate: { label: "Duplicate", bg: "rgba(239,68,68,.15)",   color: "#F87171" },
    unused:    { label: "Unused?",   bg: "rgba(245,158,11,.15)",  color: "#FCD34D" },
    trial:     { label: "Trial",     bg: "rgba(99,102,241,.15)",  color: "#A5B4FC" },
  };
  ...
  return (
    <>
      <style>{`
        ...
        @media (max-width: 640px)  { .dm-scaler { zoom: 0.62; } }
        @media (max-width: 520px)  { .dm-scaler { zoom: 0.52; } }
        @media (max-width: 430px)  { .dm-scaler { zoom: 0.44; } }
        @media (max-width: 370px)  { .dm-scaler { zoom: 0.38; } }
      `}</style>
          ...
          <div style={{
            ...
            <aside style={{
              ...
              <div style={{ padding: 16, borderBottom: "1px solid #252530" }}>
                ...
                <div style={{
                  marginTop: 10, background: "#212128",
                  border: "1px solid #303038", borderRadius: 8,
                    ...
                    <div key={item.name} style={{
                      ...
                      {item.badge && (
                        <span style={{
                          ...
                          background: item.badgeType === "r" ? "rgba(239,68,68,.2)" :
                                      item.badgeType === "y" ? "rgba(245,158,11,.2)" :
                                      "rgba(99,102,241,.2)",
                          color: item.badgeType === "r" ? "#F87171" :
                                 item.badgeType === "y" ? "#FCD34D" :
                                 "#A5B4FC",
                        }}>{item.badge}</span>
                      )}
                    </div>
              ...
              <div style={{ marginTop: "auto", padding: 10 }}>
                <div style={{
                  background: "#212128", border: "1px solid #303038",
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <div style={{
                    display: "flex", background: "#212128",
                    border: "1px solid #303038", borderRadius: 7, overflow: "hidden",
                  }}>
                    {["Month", "Quarter", "Year"].map((t, i) => (
                      <span key={t} style={{
                        fontSize: 11, padding: "5px 9px",
                        color: i === 1 ? "#fff" : "#888896",
                        background: i === 1 ? "#6366F1" : "transparent",
                      }}>{t}</span>
                    ))}
                  </div>
                  {["⚙", "🔔", "?"].map((icon, i) => (
                    <div key={i} style={{
                      width: 30, height: 30, background: "#212128",
                      border: "1px solid #303038", borderRadius: 7,
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontSize: 12, fontWeight: 600, color: "#FCA5A5" }}>
                      2 duplicate subscriptions detected — potential waste of €29.80/month
                    </div>
                    <div style={{ fontSize: 11, color: "#F87171", opacity: 0.7, marginTop: 1 }}>
                      Slack Pro appears twice · Notion appears twice
                    </div>
                  </div>
                  <div style={{ fontSize: 11, fontWeight: 600, color: "#EF4444", whiteSpace: "nowrap" }}>
                    Review duplicates →
                  </div>
                </div>
                  ...
                  {[
                    ...
                    return (
                      <div key={kpi.label} style={{
                        ...
                        <div style={{ fontSize: 10, color: kpi.warn ? "#92400E" : "#68687A", fontWeight: 500, marginBottom: 7 }}>
                          {kpi.label}
                        </div>
                        ...
                        <div style={{
                          fontSize: 18, fontWeight: 700, letterSpacing: -0.5, lineHeight: 1,
                          color: kpi.green ? "#10B981" : kpi.warn ? "#F59E0B" : "#F4F4F5",
                        }}>{kpi.value}</div>
                        <div style={{
                          fontSize: 10, marginTop: 5, display: "flex", alignItems: "center", gap: 3,
                          color: kpi.dir === "up" ? "#F87171" : kpi.dir === "dn" ? "#34D399" : "#FCD34D",
                        }}>
                          {kpi.dir === "up" ? "↑" : kpi.dir === "dn" ? "↓" : "→"} {kpi.delta}
                        </div>
                        {kpi.cta && (
                          <div style={{ fontSize: 10, color: "#818CF8", fontWeight: 600, marginTop: 4 }}>{kpi.cta}</div>
                        )}
                      </div>
                    );
                  })}
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 200px", gap: 10, flex: 1, minHeight: 0 }}>
                  ...
                  {/* Subscriptions table */}
                  <div style={{
                    background: "#1A1A22", border: "1px solid #282835",
                    borderRadius: 10, padding: 14, overflow: "hidden",
                    display: "flex", flexDirection: "column",
                  }}>
                    <div style={{
                      fontSize: 11, fontWeight: 600, color: "#A1A1AA", marginBottom: 12,
                      ...
                      <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                        <span style={{
                          ...
                          fontWeight: 600, background: "rgba(239,68,68,.15)", color: "#F87171",
                        }}>5 need action</span>
                        {["▼ Filter", "+ Add"].map((btn) => (
                          <span key={btn} style={{
                            fontSize: 10, color: "#52525F", background: "#212128",
                            border: "1px solid #303038", borderRadius: 6, padding: "3px 8px",
                          }}>{btn}</span>
                        ))}
                      </div>
                    </div>
                        ...
                        <thead>
                          <tr>
                            {["", "Name", "Category", "Users", "Next billing", "Monthly", "Status", "Owner"].map((h) => (
                              <th key={h} style={{
                                fontSize: 10, color: "#68687A", fontWeight: 500,
                                textAlign: "left", padding: "0 8px 8px",
                                borderBottom: "1px solid #282835", whiteSpace: "nowrap",
                              }}>{h}</th>
                            ))}
                          </tr>
                        </thead>
                        <tbody>
                          {subs.map((s) => (
                            <tr key={s.name}>
                                ...
                                <div style={{ display: "flex" }}>
                                  {s.users.map((u, i) => (
                                    <div key={i} style={{
                                      ...
                                      display: "flex", alignItems: "center", justifyContent: "center",
                                      marginLeft: i === 0 ? 0 : -5,
                                      background: userColors[u] ?? "#6366F1",
                                      color: "#fff", zIndex: s.users.length - i, position: "relative",
                                    }}>{u}</div>
                                  ))}
                                  {s.extra > 0 && (
                                    <div style={{
                                      ...
                                      fontSize: 7, fontWeight: 700,
                                      display: "flex", alignItems: "center", justifyContent: "center",
                                      marginLeft: -5, background: "#303038", color: "#888896", position: "relative",
                                    }}>+{s.extra}</div>
                                  )}
                                </div>
                              </td>
                              <td style={{
                                padding: "7px 8px", borderBottom: "1px solid #212128",
                                color: s.dateWarn ? "#F87171" : "#68687A", whiteSpace: "nowrap",
                              }}>{s.date}{s.dateWarn ? " ⚡" : ""}</td>
                              ...
                              <td style={{ padding: "7px 8px", borderBottom: "1px solid #212128" }}>
                                <div style={{
                                  width: 20, height: 20, background: s.ownerColor, borderRadius: "50%",
                                  display: "flex", alignItems: "center", justifyContent: "center",
                    ...
                    <div style={{
                      marginTop: 8, textAlign: "center", fontSize: 10, color: "#52525F",
                      paddingTop: 8, borderTop: "1px solid #212128",
                    }}>View all 68 subscriptions →</div>
                  </div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    ...
                    <div style={{
                      ...
                      {[
                        ...
                        <div key={item.name} style={{
                          display: "flex", alignItems: "center", gap: 8,
                          padding: "6px 0", borderBottom: "1px solid #212128",
                        }}>
                          <div style={{ width: 6, height: 6, borderRadius: "50%", background: item.dot, flexShrink: 0 }} />
                          <div style={{ flex: 1, fontSize: 11, color: "#D4D4D8", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                            {item.name}
                          </div>
                        ...
                        <div style={{ flex: 1 }}>
                          {[
                            ...
                            <div key={item.label} style={{
                              ...
                              fontSize: 10, color: "#A1A1AA", padding: "2px 0",
                            }}>
